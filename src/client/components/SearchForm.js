  ...
  return (
    <div style={{flexDirection: 'column', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
      <Form style={{ width: '20%' }} onSubmit={handleSubmit}>
        ...
        <Form.Label style={{flexDirection: 'column', paddingLeft: "1rem", paddingRight: "1rem", fontWeight: 'Bold', color: "rgb(0, 255, 225)" }}>Player Name:</Form.Label>
          <Form.Control type="text" value={name} onChange={(event) => setName(event.target.value)} />
        </Form.Group>
        </div>
        <div style={{flexDirection: 'column',paddingLeft:'7rem', paddingBottom:'2rem'}} >
